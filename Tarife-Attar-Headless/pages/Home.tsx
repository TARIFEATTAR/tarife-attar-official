...
const NOTABLE_FORMULATIONS: Product[] = [
  {
    id: 'notable-1',
    ...
    volume: '9ml',
    scentVibe: 'Woody, earthy, mineral'
  },
  {
    id: 'notable-2',
...
export const Home: React.FC<Props> = ({ onNavigate, onProductClick, onGuidedEntry }) => {
  return (
    <div className="w-full bg-theme-alabaster selection:bg-theme-industrial/30 overflow-x-hidden">
      {/* Hero Entry Section */}
      <div className="h-screen w-full relative">
        <SplitEntry onNavigate={onNavigate} onGuidedEntry={onGuidedEntry} />
      </div>
      ...
      {/* Brand Ethos Section - Stacked for Mobile */}
        ...
        <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="space-y-8 md:space-y-12">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-7xl font-serif italic leading-[1.1] md:leading-[0.9] tracking-tighter">
              Liquid Coordinates <br className="hidden sm:block" /> for the Traveler.
            </h2>
            <p className="font-serif text-lg sm:text-xl md:text-2xl opacity-50 italic leading-relaxed max-w-xl">
              We extract and stabilize atmospheric memories. Each specimen is a precise coordinate of time, altitude, and mineral density.
            </p>
