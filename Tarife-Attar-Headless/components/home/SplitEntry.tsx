    ...
    <div className="relative w-full h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <motion.section
        ...
        className={`relative flex flex-col items-center justify-center overflow-hidden cursor-pointer
          ...
          bg-theme-alabaster text-theme-charcoal transition-all duration-1000 ease-liquid`}
      >
      ...
      <motion.section
        ...
        className={`relative flex flex-col items-center justify-center overflow-hidden cursor-pointer
          ...
          bg-theme-obsidian text-theme-alabaster transition-all duration-1000 ease-liquid`}
      >
        <AnimatePresence mode="wait">
          {selection === 'idle' && (
            <motion.div
