          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden mb-6 bg-theme-charcoal/5 border border-transparent group-hover:border-theme-charcoal/20 transition-colors">
              <img 
                src={report.imageUrl} 
                alt={report.name}
                className="w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:scale-105 group-hover:opacity-100 transition-all duration-1000 ease-liquid"
              />
