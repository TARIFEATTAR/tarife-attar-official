...
export const heroBackgroundsSchema = {
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'number',
            group: 'atlas',
            description: 'How much of the cream overlay covers the texture. Lower = more visible image. (Default: 40)',
            initialValue: 40,
            validation: (Rule) => Rule.min(20).max(98),
            options: {
                list: [
                    { title: '30% (Maximum visibility)', value: 30 },
                    { title: '35%', value: 35 },
                    { title: '40% (Recommended)', value: 40 },
                    { title: '45%', value: 45 },
                    { title: '50%', value: 50 },
                    { title: '55%', value: 55 },
                    { title: '60%', value: 60 },
                    { title: '65%', value: 65 },
                    { title: '70%', value: 70 },
                    { title: '75% (Subtle)', value: 75 },
                    { title: '80% (Very subtle)', value: 80 },
                    { title: '85% (Almost solid)', value: 85 },
                ],
            },
        }),
